...
This is a network service that receives data from an IRC server and sends it to a frontend application.

## Usage
Start the network service by running:

```bash
npm run start
```

The service will listen for client/server messages forward them to the frontend application.
